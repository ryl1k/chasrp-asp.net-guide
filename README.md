...
### 1. [C# - Основи мови](#1-c---основи-мови)
...
- [1.3 Nullable Types та Null Safety](#nullable-types-та-null-safety)
- [1.4 Value Types vs Reference Types](#value-types-vs-reference-types)
- [1.5 String Interpolation та StringBuilder](#string-interpolation-та-stringbuilder)

### 2. [C# - ООП (розширення знань)](#2-c---ооп-розширення-знань)
- [2.1 Sealed Classes та методи](#sealed-classes-та-методи)
- [2.2 Extension Methods](#extension-methods)
- [2.3 Partial Classes та Methods](#partial-classes-та-methods)
- [2.4 Static Classes та Constructors](#static-classes-та-constructors)
- [2.5 Operator Overloading](#operator-overloading)

### 3. [C# - Сучасні можливості](#3-c---сучасні-можливості)
...
### 4. [ASP.NET Core - Архітектура](#4-aspnet-core---архітектура)
...
### 5. [ASP.NET Core - Web API](#5-aspnet-core---web-api)
...
### 6. [Валідація та обробка помилок](#6-валідація-та-обробка-помилок)
...
### 7. [Робота з даними](#7-робота-з-даними)
...
- [9.1 Unit Testing з xUnit, NUnit та MSTest](#unit-testing-з-xunit-nunit-та-mstest)
- [9.2 Integration Testing з TestServer](#integration-testing-з-testserver)
- [9.3 Testing Controllers та APIs](#testing-controllers-та-apis)
- [9.4 Mocking та Test Doubles](#mocking-та-test-doubles)

### 10. [ASP.NET Core 9 Features](#10-aspnet-core-9-features)
- [10.1 Native AOT Support та Performance Improvements](#native-aot-support-та-performance-improvements)
- [10.2 Enhanced Blazor Server та WebAssembly Features](#enhanced-blazor-server-та-webassembly-features)
- [10.3 OpenAPI and Swagger Improvements](#openapi-and-swagger-improvements)
